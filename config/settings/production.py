...
ALLOWED_HOSTS = env.list(
    "DJANGO_ALLOWED_HOSTS", default=["pontualimportbrindes.com.br"]
)
...
DEFAULT_FROM_EMAIL = env(
    ...
    default="Sistema <noreply@pontualimportbrindes.com.br>",
)
...
EMAIL_SUBJECT_PREFIX = env(
    "DJANGO_EMAIL_SUBJECT_PREFIX", default="[Sistema]"
)
